...
Airphoto footprint estimation and coverage selection for British Columbia. Estimate ground footprints from airphoto centroids and
scale, compute coverage of areas of interest, and select minimum photo sets using greedy set-cover.
